...
\pagestyle{fancy}
\fancyhf{}
\rhead{ME228 Project Report}
\lhead{Fatigue Strength Prediction in Low-Alloy Steels}
\rfoot{\thepage}

%% ── Title ───────────────────────────────────────────────────────────────────
\title{
  \Large\textbf{ME228 — Project Final Report}\\[6pt]
...
\]
and train \textbf{separate expert models} per metallurgical regime. This alone reduced RMSE by
...
\begin{enumerate}[nosep]
  \item \textbf{Carburised data scarcity} ($N=48$) limits prediction reliability
        ...
        the uncertainty.
  \item \textbf{Normality of NC residuals} is borderline. For safety-critical applications, a
        bootstrap or quantile-regression uncertainty estimate is preferable to
        $\Phi(\cdot/\text{RMSE})$.
